	...
	public List<CotizacionDTO> buscarCotizacionPag(
		...
		try {
			if (cotizacionViene == null) {
				...
				if(!"".equals(cotizacionViene.getNom_trabajador())){
					System.out.println("nomsuario");
					cotizacionViene.setNom_trabajador("%"+cotizacionViene.getNom_trabajador()+"%");
	...
	public List<CotizacionDTO> buscarCotizacion(CotizacionDTO cotizacionViene)
		...
		try {
			if (cotizacionViene == null) {
				...
				System.out.println("nomusu:"+cotizacionViene.getNom_trabajador()); 
