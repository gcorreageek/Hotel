...
import com.hotel.seguridad.service.AccesoService;
import com.hotel.seguridad.service.AreaService;
import com.hotel.seguridad.service.MenuService;
...
//	lstMenuTabla = objAccesoServ.listaAcceso(idCargo)
	...
	@Action(value = "/cambiarEstadoAcceso", results = { @Result(name = "success", location = "/paginas/mantenimientos/mensaje_trabajador.jsp") })
