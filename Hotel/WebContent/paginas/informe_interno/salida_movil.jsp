...
<%@ page language="java" contentType="text/html"  import="com.hotel.mantenimiento.bean.ArticuloDTO"%>
...
<input type="text" id="inputNombre" name="objProducto.desc_articulo" value="${objProducto.desc_articulo}" placeholder="Nombre">
<s:select   
