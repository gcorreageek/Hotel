...
// 	alert('ddd');
	...
	} 									//Cod_solicitud_requerimiento
	$.post("guardarIIS",{"objInformeInterno.cod_solicitud_requerimiento":codPedido,"objInformeInterno.obs_informeinterno":observacion},function(data){
...
// 	}
	...
	$('#idBuscarPedido').click(function(){
		 ...
		 $("#txtFechaInicio").val("");
		 $("#txtFechaFin").val("");
		$.post("listarSolicitudReqTotalAprobados",function(data){
	 		$("#divDatosPedidoTotal").html(data);
		}); 
		$.post("listarSolicitudReqPagModalAprobados",{inicio:null,"codProd":$("#cod_articulo").val()},function(data){
...
// 		txtNombreResponsable cboArea txtFechaInicio txtFechaFin cboTipo 
		...
		$.post("buscarSolicitudReqTotalAprobados",{
		...
		$.post("buscarSolicitudReqPagModalAprobados",{
			"objPedido.nom_trabajador":txtNombreRespo,
			"objPedido.cod_area":cboArea,
			"objPedido.fechaInicio":txtFechaInicio,
			"objPedido.fechaFin":txtFechaFin,
...
<div id="myIIS" class="modal fade" tabindex="-1"   >
<div class="modal-dialog">
<div class='modal-content'>
