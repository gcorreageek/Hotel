              ...
              <c:if test="${requestScope.lstUsuario!=null}"   > 
			     <c:forEach  items="${requestScope.lstUsuario}"  var="row"  >
			     	<tr> 
	                  ...
	                  <td align="center"><button onclick="javascript:seleccionaUsuario(${row.cod_trabajador},"${row.desc_usuario}");" type="button" class="btn btn-link" data-dismiss="modal" aria-hidden="true">[Seleccionar]</button></td> 
	                </tr>
			     </c:forEach> 
		      </c:if>   
              </tbody>
