...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
			...
			<input type="hidden"  name="codProd" value="${objProducto.cod_articulo}" id="codProd"     />
			<div class="control-group">
			<label class="control-label" for="inputNombre">Nombre</label>
			<div class="controls">
			<input type="text" id="inputNombre" name="objProducto.desc_articulo" value="${objProducto.desc_articulo}" placeholder="Nombre" disabled>
			</div>
			</div> 
			<div class="control-group">
      ...
      <hr> 
       <footer>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
        <a href="https://github.com/edinson/" target="_blank"  >@edinson&nbsp;&nbsp;<img src="<%=request.getContextPath()%>/assets/megamix/images/edinson.jpg" class="img-polaroid"></a>    </p>
      </footer>
