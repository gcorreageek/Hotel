...
INSERT INTO `tb_articulo` (`cod_articulo`,`desc_articulo`,`unidadMedida`,`tipo_articulo`,`stock_articulo`,`habilitado`) VALUES 
 (1,'Trapeador','Unidad','Insumo',1220,'Habilitado'),
 (2,'Escoba','Unidad','Insumo',20,'Habilitado'),
 (3,'Detergente','Unidad','Insumo',0,'Habilitado'),
 (5,'Cera para piso','Unidad','Insumo',0,'Habilitado'),
 (6,'Ganchos','Docena','Insumo',0,'Habilitado'),
 ...
 (13,'borrar','Unidad',NULL,0,'Habilitado'),
 (14,'boreera','Unidad','Perecible',0,'Habilitado');
...
CREATE TABLE `tb_cotizacion` (
  ...
  `fecha_devolucion_cotizacion` date DEFAULT NULL,
...
INSERT INTO `tb_cotizacion` (`cod_cotizacion`,`obs_cotizacion`,`cod_trabajador`,`fecharegistro_cotizacion`,`cod_proveedor`,`tipo_cotizacion`,`fecha_devolucion_cotizacion`,`fecha_entrega_cotizacion`) VALUES 
 (1,NULL,1,'2014-01-17 04:56:24',1,NULL,NULL,NULL),
 (2,NULL,1,'2014-01-17 06:08:16',1,NULL,NULL,NULL),
 (3,NULL,1,'2014-01-18 15:27:05',1,NULL,NULL,NULL),
 (4,NULL,1,'2014-01-19 03:06:29',1,NULL,NULL,NULL),
 (5,NULL,1,'2014-01-19 03:10:59',1,NULL,NULL,NULL),
 (6,NULL,1,'2014-01-19 05:42:07',1,NULL,NULL,NULL),
 (7,NULL,1,'2014-01-19 05:47:37',1,'Abastecimiento',NULL,NULL),
 (8,NULL,1,'2014-01-19 05:48:45',1,'Prestamo','2014-01-21','2014-01-19');
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1 COMMENT='proveedor(recepcion de los articulos)';
...
INSERT INTO `tb_informe_externo` (`cod_informe_externo`,`fecha_informe_externo`,`tipo_informe_externo`,`cod_trabajador`,`cod_ordencompra`,`obs_informeexterno`) VALUES 
 ...
 (4,'2014-01-18 14:38:17','Entrada',1,3,'ddd'),
 (5,'2014-01-18 15:33:32','Entrada',1,4,'e ta ok todo los prod'),
 (6,'2014-01-18 15:36:02','Salida',1,4,'');
...
CREATE TABLE `tb_ordencompra` (
  ...
  `fecha_devolucion_ordencompra` date DEFAULT NULL,
  `fecha_entrega_ordencompra` date DEFAULT NULL,
...
INSERT INTO `tb_ordencompra` (`cod_OrdenCompra`,`fecharegistro_ordencompra`,`cod_trabajador`,`cod_cotizacion`,`cod_proveedor`,`estado_ordencompra`,`tipo_ordencompra`,`fecha_devolucion_ordencompra`,`fecha_entrega_ordencompra`) VALUES 
 (1,'2014-01-17 05:26:52',1,1,1,'Pendiente',NULL,NULL,NULL),
 (2,'2014-01-17 06:08:43',1,2,1,'Pendiente',NULL,NULL,NULL),
 (3,'2014-01-17 06:08:56',1,2,1,'Entregada',NULL,NULL,NULL),
 (4,'2014-01-18 15:31:10',1,3,1,'Pendiente',NULL,NULL,NULL),
 (5,'2014-01-19 04:04:02',1,3,1,'Pendiente',NULL,NULL,NULL);
...
INSERT INTO `tb_solicitud_requerimiento` (`cod_solicitudRequerimiento`,`cod_trabajador`,`comentario_solicitud_requerimiento`,`tipo_solicitud_requerimiento`,`fechaDevolucion_solicitud_requerimiento`,`fechaRegistro_solicitud_requerimiento`,`fechaEntrega_solicitud_requerimiento`,`estado_solicitud_requerimiento`,`fechaEvaluacion_solicitud_requerimiento`,`comentarioevaluacion_solicitud_requerimiento`) VALUES 
 ...
 (4,1,'ok prueba','Abastecimiento','2014-03-07','2014-01-19 00:58:53','2014-01-07','Aprobado','2014-01-19 01:45:20','ok aprueba la pruwba'),
 (5,1,'okis','Abastecimiento',NULL,'2014-01-19 02:27:43','2014-01-19','Desaprobado','2014-01-19 02:30:53','ok no importa'),
 (6,1,'','Abastecimiento',NULL,'2014-01-19 02:32:10','2014-01-19','Aprobado','2014-01-19 02:32:50','okm lo apruebo');
...
INSERT INTO `tb_trabajador` (`cod_trabajador`,`nom_trabajador`,`correo_trabajador`,`cod_cargo`,`usu_trabajador`,`pass_trabajador`,`habilitado`) VALUES 
 ...
 (8,'gustavo','edinson@gmail.com',29,'nn9','d033e22ae348aeb5660fc2140aec35850c4da997','Desabilitado'),
 (9,'Gustavo','ggg',27,'gcorreageek4','d033e22ae348aeb5660fc2140aec35850c4da997','Habilitado'),
 (10,'gustavo','edinson@gmail.com',29,'gcorreageek67','d033e22ae348aeb5660fc2140aec35850c4da997','Habilitado'),
 (11,'Gustavo','edinson@gmail.com',1,'gcorreageek98','d033e22ae348aeb5660fc2140aec35850c4da997','Habilitado'),
